...
private:
    ...
    KDNodePtr findTriangle_(const std::vector<std::vector<Vertex>> *pvvVertex,
                            const std::vector<Triangle> *pTriangle,
                            const point_t &pt, const size_t &levl,
                            const KDNodePtr &branch, const KDNodePtr &best);
...
public:
    ...
    /**
     * @brief findTriangle_index: 寻找点所位于的三角形
     * @param pvvVertex
     * @param pTriangle
     * @param pt: 点
     * @舍弃:有错误,
     * @return
     */
    size_t findTriangle_index(const std::vector<std::vector<Vertex>> *pvvVertex,
                              const std::vector<Triangle> *pTriangle,
                              const point_t &pt);
